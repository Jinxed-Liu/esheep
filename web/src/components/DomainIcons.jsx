...
export function WeightGlyph({ size = 24, className, "aria-hidden": ariaHidden = true }) {
  return (
    ...
    >
      ...
      <path d="M12 7c1.956 0 3.724.802 5 2.095l-2.956 2.904a3 3 0 0 0-2.038-.799 3 3 0 0 0-2.038.798L7.012 9.095A6.979 6.979 0 0 1 12.012 7" />
    </svg>
  );
}
