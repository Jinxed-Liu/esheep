-- Deployed follow-up adds actual private Storage object totals.
drop function if exists public.get_farm_storage_metrics(uuid);

create function public.get_farm_storage_metrics(
  p_farm_id uuid
)
returns table (
  farm_id uuid,
...
begin
  ...
  select
    ...
    (
      ...
      where object.bucket_id in ('farm-assets', 'farm-checkpoints')
