...
actor FarmCheckpointActor {
    ...
    private static func restorePriority(_ entityType: String) -> Int {
        ...
        case .pen, .feedIngredient, .semen, .breedingProgram: 0
        case .sheep, .productionBatch, .feedRecipe, .inventoryLot: 1
        case .feedRecipeComponent, .weight, .weaning, .transfer, .removal, .batchMembership, .feed, .health, .reproduction, .note: 2
        case .feedLine, .inventoryTransaction, .photoAsset: 3
        case .farm, .none: 4
        }
    }
}
